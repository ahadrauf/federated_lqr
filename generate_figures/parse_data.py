...
latexify(fig_width=7.5, fig_height=7.5)
...
def plot_losses(costs_lr, costs_admm, costs_centralized, costs_fedadmm, costs_pfedadmm, verbose=False, plot=False):
    ...
    axs[0, 0].scatter(idx_plot, mean_lr, s=8, marker='o', c='cyan', label='Policy Fitting')
    ...
    axs[0, 0].fill_between(idx_plot, mean_fedadmm - std_fedadmm / 3, mean_fedadmm + std_fedadmm / 3, alpha=.3,
                           color='orange')
    ...
    axs[1, 0].fill_between(idx_plot, mean_cent_KQR['K'] - std_cent_KQR['K'] / 3,
                           mean_cent_KQR['K'] + std_cent_KQR['K'] / 3 / 3,
                           alpha=.3, color='red')
    ...
    axs[0, 1].fill_between(idx_plot, mean_cent_KQR['Q'] - std_cent_KQR['Q'] / 3,
                           mean_cent_KQR['Q'] + std_cent_KQR['Q'] / 3 / 3,
                           alpha=.3, color='red')
    ...
    axs[1, 1].fill_between(idx_plot, mean_cent_KQR['R'] - std_cent_KQR['R'] / 3,
                           mean_cent_KQR['R'] + std_cent_KQR['R'] / 3 / 3,
                           alpha=.3, color='red')
