...
average_over = 10
alpha = 0.5  # multiplier on r(K, Q, R)
beta = 0.1  # multiplier on l_D
# A = np.array([
#     [.99997, .039, 0, -.322],
#     [-.065, .99681, 7.74, 0],
#     [.02, -.101, .99571, 0],
...
latexify(fig_width=6*3.5, fig_height=2.7*3.5)
